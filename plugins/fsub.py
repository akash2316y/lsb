...
async def change_force_sub_mode(client: Client, message: Message):
    ...
    await asyncio.gather(*(get_channel_info(ch_id) for ch_id in channels))
...
# Add channel
@Bot.on_message(filters.command('addfsub') & filters.private & is_owner_or_admin)
...
# Delete channel
@Bot.on_message(filters.command('delfsub') & filters.private & is_owner_or_admin)
async def del_force_sub(client: Client, message: Message):
    ...
    if len(args) != 2:
        return await temp.edit("<b>Usage:</b> <code>/delfsub <channel_id | all></code>")
...
# View all channels
@Bot.on_message(filters.command('fsubs') & filters.private & is_owner_or_admin)
